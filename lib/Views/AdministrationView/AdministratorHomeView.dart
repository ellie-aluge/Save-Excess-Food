...
import 'package:fyp/Views/AdministrationView/VerifyUserView.dart';

class AdministratorHomeView extends StatefulWidget {
  const AdministratorHomeView({Key? key}) : super(key: key);

  @override
  State<AdministratorHomeView> createState() => _AdministratorHomeViewState();
}

class _AdministratorHomeViewState extends State<AdministratorHomeView> {
        ...
        child: Scaffold(
            ...
            bottom: TabBar(
                ...
                tabs: [
                  ...
                  Tab(icon: Image.asset(
                      ...
                      text: 'NGO'),
                  Tab(icon: Icon(Icons.dashboard), text: 'Requests'),
          ...
          body: TabBarView(
            children: [
              ...
              // Widget for the Account Verification Requests
          SingleChildScrollView(
                  child: VerifyUserView(),
