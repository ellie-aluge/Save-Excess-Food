...
import 'package:fyp/Views/DeliveryView/DeliveryAssignmentView.dart';
import 'package:fyp/Views/NgoView/AnalysisView.dart';
import 'package:fyp/Views/DeliveryView/DeliveryProfile.dart';
import 'package:fyp/Views/DeliveryView/AddVehicleView.dart';
        ...
        child: Scaffold(
            ...
            bottom: TabBar(
                ...
                tabs: [
                  ...
                  Tab(icon: Image.asset(
                      ...
                      text: 'NGO'),
                  Tab(icon: Icon(Icons.task), text: 'Assignment'),
          ...
          body: TabBarView(
            children: [
              ...
              // Widget for the Add vehicle View.
              AddVehicleView(),
